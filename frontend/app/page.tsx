...
import { Activity, ArrowRight, BrainCircuit, Check, LockKeyhole, Network, ShieldCheck, UserCheck } from 'lucide-react'
...
const capabilities = [
  ...
  { icon: UserCheck, title: 'Continuous authentication', text: 'Re-evaluate trust as devices, networks, and behavior change.' },
